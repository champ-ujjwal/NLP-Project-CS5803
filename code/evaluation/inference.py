...
def inference(bin_path, data_folder, dev_suffix, test_suffix, ref_suffix, max_len, batch_size):
    # Your code here
    pass
...
# change1    
    bin_path = "../../experiments/experiment_name/bin.bin"
    data_folder = "../experiments/experiment_name"
    dev_suffix = ".bin"
    test_suffix = ".bin"
    ref_suffix = ".bin"
    max_len = 512
    ...
    inference(bin_path, data_folder, dev_suffix, test_suffix, ref_suffix, max_len, batch_size)
 # change1end  
    ...
    # sig = inspect.getfullargspec(batch_inference)
